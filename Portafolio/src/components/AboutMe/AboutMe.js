...
function Education() {
  return (
    <div className={styles.educationSection}>
      <h2>Ingeniería en Software (2020-presente) (Estudiante)</h2>
      <h4>Universidad de las Fuerzas Armadas ESPE</h4>
      <p>
        Actualmente en sexto e la UPP obtuve capacidad de responsabilidad,
    ...
    <section className={styles.aboutMe} id="about">
      <div className={styles.aboutContainer}>
        <div className={styles.AboutLeft}>
          <span>Actualizado el 11 de Mayo, 2024</span>
